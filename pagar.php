...
?>
<!-- Cambiar el ID de Cliente de Paypall :P -->
<script src="https://www.paypal.com/sdk/js?client-id=CLIENT-ID&currency=USD"></script> 
<div class="mt-5 p-2 text-center bg-dark text-white rounded">
    ...
    <p>Los productos podrán ser enviados una vez que se procese el pago.</br>
        <strong>(Para aclaraciones: hello@gaelst.com)</strong>
    </p>
</div>
<script>
      paypal.Buttons({
